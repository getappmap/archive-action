...
const executeCommand_1 = __nccwpck_require__(285);
class Archiver {
...
const Archiver_1 = __importDefault(__nccwpck_require__(626));
const verbose_1 = __importDefault(__nccwpck_require__(753));
class ActionLogger {
    debug(message) {
        core.debug(message);
...
function runInGitHub() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const archiver = new Archiver_1.default(new ActionLogger());
